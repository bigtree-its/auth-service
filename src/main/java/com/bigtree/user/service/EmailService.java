...
import com.bigtree.user.config.ResourcesConfig;
...
public class EmailService {
    ...
    public void setOnetimePasscode(String email, String customerName, String otp) {
        ...
        try {
            ...
            params.put("customerEmail", cryptoHelper.encryptAndEncode(email));
            params.put("otp", cryptoHelper.encryptAndEncode(otp));
            params.put("queryString", cryptoHelper.encryptUrl(queryString));
            sendMail(email, "Reset your password | HouseOfChef", "password-reset-instructions", params);
        } catch (Exception e) {
