...
public class UserController {
    ...
    @GetMapping("")
    public ResponseEntity<List<User>> getAll(@RequestParam(value = "name", required = false) String name, @RequestParam(value = "email", required = false) String email, @RequestParam(value = "userType", required = false) String userType){
        log.info("Received request to get all identities");
        List<User> identities = userService.getUsers(name, email, userType);
